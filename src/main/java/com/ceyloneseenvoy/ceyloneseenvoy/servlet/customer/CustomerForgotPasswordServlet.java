            ...
            if (result != null) {
                try {
                    ...
                    String message = "<!DOCTYPE HTML\n" +
                            ...
                            "                              <div align=\"left\">\n" +
                            "                                <!--[if mso]><v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\"http://localhost:8080/CeyloneseEnvoy-1.0-SNAPSHOT/auth/customer/reset-password.jsp?email=" + email + "&uuid=" + uuid.toString() + "\" style=\"height:47px; v-text-anchor:middle; width:177px;\" arcsize=\"2%\"  stroke=\"f\" fillcolor=\"#18163a\"><w:anchorlock/><center style=\"color:#FFFFFF;font-family:'Lato',sans-serif;\"><![endif]-->\n" +
                            "                                <a href=\"http://localhost:8080/CeyloneseEnvoy-1.0-SNAPSHOT/auth/customer/reset-password.jsp?email=" + email + "&uuid=" + uuid.toString() + "\"\n" +
