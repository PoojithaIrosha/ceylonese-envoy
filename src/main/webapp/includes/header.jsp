                                                ...
                                                <div class="tabs__content js-tabs-content">
                                                    <div class="tabs__pane -tab-item-1 is-tab-el-active">
                                                        <div class="mega__content">
                                                            <div class="mega__grid">
                                                                <div class="mega__item">
                                                                    ...
                                                                    <div class="y-gap-5 text-15 pt-5">
                                                                        <div>
                                                                            <a href="hotel-list-1.html">Hotel List
                                                                                v1</a>
                                                                        </div>

                                                                        <div>
                                                                            <a href="hotel-list-2.html">Hotel List
                                                                                v2</a>
                                                                        </div>

                                                                        <div>
                                                                            <a href="hotel-half-map.html">Hotel List
                                                                                v3</a>
                                                                        </div>

                                                                        <div>
                                                                            <a href="hotel-grid-1.html">Hotel List
                                                                                v4</a>
                                                                        </div>

                                                                        <div>
                                                                            <a href="hotel-grid-2.html">Hotel List
                                                                                v5</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mega__item">
                                                                    ...
                                                                    <div class="y-gap-5 text-15 pt-5">
                                                                        <div>
                                                                            <a href="hotel-single-1.html">Hotel Single
                                                                                v1</a>
                                                                        </div>

                                                                        <div>
                                                                            <a href="hotel-single-2.html">Hotel Single
                                                                                v2</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mega__item">
                                                                    ...
                                                                    <div class="y-gap-5 text-15 pt-5">
                                                                        <div>
                                                                            <a href="booking-pages.html">Booking
                                                                                Page</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="mega__image d-flex relative">
                                                                <img src="#" data-src="assets/img/backgrounds/7.png"
                                                                     alt="image"
                                                                ...
                                                                <div class="absolute w-full h-full px-30 py-24">
                                                                    ...
                                                                    <button class="button h-50 px-30 -blue-1 text-dark-1 bg-white mt-20">
                                                                        Experinces
                                                                    </button>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="tabs__pane -tab-item-2">
                                                        <div class="mega__content">
                                                            ...
                                                            <div class="mega__image d-flex relative">
                                                                <%-- <img src="${contextPath}/assets/img/backgrounds/7.png" alt="image" class="rounded-4" /> --%>
                                                        ...
                                                        <div class="mega__content">
                                                            <div class="mega__grid">
                                                                <div class="mega__item">
                                                                    ...
                                                                    <div class="y-gap-5 text-15 pt-5">
                                                                        <div>
                                                                            <a href="activity-list-1.html">Activity List
                                                                                v1</a>
                                                                        </div>

                                                                        <div>
                                                                            <a href="activity-grid-1.html">Activity List
                                                                                v2</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mega__item">
                                                                    ...
                                                                    <div class="y-gap-5 text-15 pt-5">
                                                                        ...
                                                                        <div>
                                                                            <a href="activity-single.html">Activity
                                                                                Single</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="mega__content">
                                                            <div class="mega__grid">
                                                                <div class="mega__item">
                                                                    ...
                                                                    <div class="y-gap-5 text-15 pt-5">
                                                                        <div>
                                                                            <a href="rental-list-1.html">Rental List
                                                                                v1</a>
                                                                        </div>

                                                                        <div>
                                                                            <a href="rental-grid-1.html">Rental List
                                                                                v2</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mega__item">
                                                                    ...
                                                                    <div class="y-gap-5 text-15 pt-5">
                                                                        ...
                                                                        <div>
                                                                            <a href="rental-single.html">Rental
                                                                                Single</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="mega__content">
                                                            <div class="mega__grid">
                                                                <div class="mega__item">
                                                                    ...
                                                                    <div class="y-gap-5 text-15 pt-5">
                                                                        <div>
                                                                            <a href="cruise-list-1.html">Cruise List
                                                                                v1</a>
                                                                        </div>

                                                                        <div>
                                                                            <a href="cruise-grid-1.html">Cruise List
                                                                                v2</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mega__item">
                                                                    ...
                                                                    <div class="y-gap-5 text-15 pt-5">
                                                                        ...
                                                                        <div>
                                                                            <a href="cruise-single.html">Cruise
                                                                                Single</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="mega__content">
                                                            <div class="mega__grid">
                                                                <div class="mega__item">
                                                                    ...
                                                                    <div class="y-gap-5 text-15 pt-5">
                                                                        <div>
                                                                            <a href="flights-list.html">Flight list
                                                                                v1</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <ul class="subnav mega-mobile">
                                            ...
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="subnav">
                                                    ...
                                                    <li>
                                                        <a href="hotel-single-1.html">Hotel Single v1</a>
                                                    </li>

                                                    <li>
                                                        <a href="hotel-single-2.html">Hotel Single v2</a>
                                                    </li>
                                            ...
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="subnav">
                                                    ...
                                                    <li>
                                                        <a href="activity-list-1.html">Activity List v1</a>
                                                    </li>

                                                    <li>
                                                        <a href="activity-grid-1.html">Activity List v2</a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a href="activity-single.html">Activity Single</a>
                                                    </li>
                                                </ul>
                                            </li>
                    ...
                    <%-- <div class="row x-gap-20 items-center xxl:d-none">
                      ...
                      <div class="col-auto">
                        <button class="d-flex items-center text-14 text-white" data-x-click="lang">
                          <img src="assets/img/general/SL4.png" alt="image" class="rounded-full mr-10" />
                          <span class="js-language-mainTitle">Sri Lanka</span>
