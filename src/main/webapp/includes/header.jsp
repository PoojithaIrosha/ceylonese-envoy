                          ...
                          <div class="tabs__pane -tab-item-1 is-tab-el-active">
                            <div class="mega__content">
                              <div class="mega__grid">
                                <div class="mega__item">
                                  ...
                                  <div class="y-gap-5 text-15 pt-5">
                                    ...
                                    <div>
                                      <a href="hotel-half-map.html">Hotel List v3</a>
                                    </div>

                                    <div>
                                      <a href="hotel-grid-1.html">Hotel List v4</a>
                                    </div>

                                    <div>
                                      <a href="hotel-grid-2.html">Hotel List v5</a>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="mega__image d-flex relative">
                                <img src="#" data-src="assets/img/backgrounds/7.png" alt="image"
                            ...
                            <div class="mega__content">
                              <div class="mega__grid">
                                <div class="mega__item">
                                  ...
                                  <div class="y-gap-5 text-15 pt-5">
                                    <div>
                                      <a href="flights-list.html">Flight list v1</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
