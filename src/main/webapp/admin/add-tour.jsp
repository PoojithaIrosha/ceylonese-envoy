                    ...
                    <div class="tabs__content js-tabs-content">
                        <div class="tabs__pane -tab-item-1 is-tab-el-active">
                            <div class="col-xl-10">
                                ...
                                <form method="post" action="add-tour" enctype="multipart/form-data" class="row x-gap-20 y-gap-20">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="cancellation" id="cancellation"></textarea>
                                    </div>

                                    <div class="col-12">
                                        <label class="lh-1 text-16 mb-2">Inclusions (Optional)</label>
                                        <textarea name="inclusions" id="inclusions"></textarea>
                                    </div>

                                    <div class="col-12">
                                        <label class="lh-1 text-16 mb-2">Exclusions (Optional)</label>
                                        <textarea name="exclusions" id="exclusions"></textarea>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="container p-3 d-flex gap-3" id="tiContainer"></div>
                                        <div>
                                            <input onchange="selectTourImages()" name="images" id="images" multiple type="file" hidden="hidden">
