...
<%@ page import="com.ceyloneseenvoy.ceyloneseenvoy.model.Admin" %>
    ...
    <div class="dashboard__main">
        <div class="dashboard__content py-10 px-40">
            ...
            <div class="row y-gap-20 justify-between items-end">
                <div class="col-auto">
                    <h1 class="text-30 lh-14 fw-600">All Admins</h1>
                </div>
                <div class="col-auto">
                    <a href="add-admin.jsp" class="button h-50 px-24 -dark-1 bg-blue-1 text-white">
                        Add Admin
                    ...
                    <div class="tabs__content pt-30 js-tabs-content">
                        <div class="tabs__pane -tab-item-1 is-tab-el-active">
                            <div class="overflow-scroll scroll-bar-1">
                                ...
                                <form action="all-admins.jsp" class="py-2 d-flex gap-4">
                                ...
                                <table class="table-4 -border-bottom col-12">
                                    ...
                                    <%
                                        ...
                                        try (Session hs = HibernateUtil.getSessionFactory().openSession()) {
                                            ...
                                            List<Admin> admins = hs.createQuery(query)
                                    ...
                                    <c:forEach items="${admins}" var="admin">
                                        <tr>
                                            <td>${admin.email}</td>
                                            <td>
                                                <span class="rounded-100 py-4 px-10 text-center text-14 fw-500 bg-yellow-4 text-yellow-3">${admin.status}</span>
                                            </td>
                                            <td>
                                                <div class="row x-gap-10 y-gap-10 items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <button onclick="changeAdminStatus('${admin.id}')"
                                                                class="flex-center bg-light-2 rounded-4 size-35">

                                                            <%
                                                                Admin admin = (Admin) pageContext.getAttribute("admin");
                                                    ...
                                                    <div class="col-auto">
                                                        <button onclick="deleteAdmin('${admin.id}')" class="flex-center bg-light-2 rounded-4 size-35">
                                                            <i class="icon-trash text-16 text-light-1"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                            </td>
